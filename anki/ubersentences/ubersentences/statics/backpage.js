...
var CORS_PROXY = "https://ssproxy.de/";
...
function renderEnlargedHanzi(jQuerySelection) {
    var value = jQuerySelection.html();
    var chineseChars = /([\u4E00-\u9FFF]+)/g;
    value = value.replace(chineseChars, function(match) {
        return "<span style='font-size:1.8em'>" + match + "</span>";
    });
    jQuerySelection.html(value);
}
